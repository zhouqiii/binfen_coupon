<template>
  <div class="myTicket">
    <!-- 头部导航 -->
    <van-nav-bar @click-left="onClickLeft" class="headTicket" title="我的票券" left-arrow :fixed="true" :placeholder="true" >
    </van-nav-bar>
    <!-- 票券5大类型 -->
    <div class="ticket">
        <van-tabs color="#F44336" line-width="60px" line-height="3px"  type="line" 
        title-active-color="#F44336" @click="getTicketInfo">
            <van-tab 
            ...
            >
                ...
                <div v-else-if="item.title == '聪明购券'">
                    <div class="cleverphoto">
                        <img src="@/assets/myTicket/clevergo@2x.png"/>
                    </div>
                    <div @click="goclever" class="clevergo">聪明购优惠券查看</div>
                </div>
                <!--乘车券-->
                <div v-else-if="item.title == '乘车券'">
                  <div class="cleverphoto">
                      <img src="@/assets/myTicket/clevergo@2x.png"/>
                  </div>
                  <div class="clevergo" @click="goCoupon">乘车券查询</div>
                </div>
                <van-list
                  v-else
                  v-model="loading"
                ...
                >
                  ...
                  <div v-else-if="kongCouponList">
                    ...
                    <div class="notYet">暂无可用票券</div>
                  </div>
                  <div v-else class="orderUl">
                    <div v-for="(item,index) in couponList" :key="2^index" 
    ...
    <div class="ticket-tabbar">
        ...
        <div class="vantab">
            ...
            line-width="0"
            >
                <van-tab title="优惠券历史记录">
                  <template #title><img class="bottomBar" src="@/assets/myTicket/record-icon@2x.png"/>优惠券历史记录</template>
                </van-tab>
                <!-- <van-tab  title="领更多好券">
                  <template #title>
                    <div style="display:flex;">
                      <div>
                        <img class="bottomBar" src="@/assets/myTicket/more-icon@2x.png"/>
                      </div>
                      <div style="line-height:1.375rem;">领更多好券</div>
                    </div>
                  </template>
                </van-tab> -->
            </van-tabs>
...
export default {
  ...
  methods:{
    ...
    //乘车券页面跳转
    goCoupon(){
      //测试地址：  https://www.alex188.cn/szmlife/mobilelife/html5/707/unionPayBusCodeCounpon/index.html#/unionPayBusCodeCounpon/counponSearch.html?hideTitle=1
      window.location.replace('https://mlife.jf365.boc.cn/mlife/mobilelife/html5/707/unionPayBusCodeCounpon/index.html#/unionPayBusCodeCounpon/counponSearch.html?hideTitle=1')
    },
    // 底部tab跳转
    viewRecords(name,title){
        // console.log(title)
        if(title == '优惠券历史记录'){
            this.$router.push({
          ...
          this.callAppMethod({
            ...
            parameters:{
              uiJump:'2',
              //测试地址：    https://www.alex188.cn/mlife/mobilelife/html5/107/ColorfulLife_motionHealth_XW/index.html#/couponListPage?channelFrom=mlifeCoupon&channel=2&hideTitle=1
              //正式环境：https://mlife.jf365.boc.cn/mlife/mobilelife/html5/107/ColorfulLife_motionHealth_XW/index.html#/couponListPage?channelFrom=mlifeCoupon&channel=2&hideTitle=1
              uiJumpUrl:'https://mlife.jf365.boc.cn/mlife/mobilelife/html5/107/ColorfulLife_motionHealth_XW/index.html#/couponListPage?channelFrom=mlifeCoupon&channel=2&hideTitle=1'
            }
          })
        }
    },
